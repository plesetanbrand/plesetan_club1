...
const products = [
    {
        id: 1,
        name: "PLESETAN TEES 88",
        price: 150000,
        category: "tshirt",
        image: "assets/product/prod1.jpg"
    },
    {
        id: 2,
        name: "PLESETAN TEES PU$$Y",
        price: 150000,
        category: "tshirt",
        image: "assets/product/prod2.jpg"
    },
    {
        id: 3,
        name: "PLESETAN LIGHTER OG",
        price: 99000,
        category: "acc",
        image: "assets/product/prod3.jpg"
    },
    {
        id: 4,
        name: "JUST DON'T IT",
        price: 275000,
        category: "tshirt",
        image: "assets/product/prod4.jpg"
    },
    {
        id: 5,
        name: "OFF-WHITE-ISH",
        price: 480000,
        category: "hoodie",
        image: "assets/product/prod5.jpg"
    },
    {
        id: 6,
        name: "UNBRANDED CAP",
        price: 150000,
        category: "acc",
        image: "assets/product/prod6.jpg"
    }
];
...
function renderProducts(filter = 'all') {
    ...
    filteredProducts.forEach((product, index) => {
        ...
        const placeholderUrl = generatePlaceholder(product.name, accent);

        // Use the product image if available, otherwise fallback to placeholder
        // logic: src starts as product.image. if it fails (onerror), it swaps to placeholderUrl

        const productEl = document.createElement('div');
        productEl.classList.add('product-card');
        productEl.innerHTML = `
            <div class="product-image">
                <img src="${product.image}" alt="${product.name}" onerror="this.onerror=null; this.src='${placeholderUrl}';">
